...
class Top extends React.Component {
  toggleMenu(e) {
    e.target.className = e.target.className === 'toggle-menu' ? 'toggle-menu active' : 'toggle-menu';
  }
    ...
    return(
      <div className="header__top">
        <div className="inner">
          ...
          <button className="toggle-menu" onClick={(event) => this.toggleMenu(event)}><span></span></button>
